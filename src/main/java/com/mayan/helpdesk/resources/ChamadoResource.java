...
import com.mayan.helpdesk.domain.dtos.ChamadoDTO;
import com.mayan.helpdesk.services.ChamadoService;

@RestController // Marca uma classe como controlador Spring, ela retorna dados diretamente em vez de exibir uma página HTML. 
@RequestMapping(value = "/chamados") // Mapeia URL's para classes ou métodos específicos.
